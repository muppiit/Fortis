    ...
    <div class="container">
        ...
        @if (auth()->user()->role->level === 'super_super_admin')
            <div class="card">
                ...
                <div style="padding:1.5rem;display:flex;flex-direction:column;gap:1rem;">
                    ...
                    <form action="{{ route('admin.attendance.update-working-hours') }}" method="POST"
        ...
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div style="position:relative;flex:1;max-width:300px;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none"
                        ...
                        style="position:absolute;left:.75rem;top:50%;transform:translateY(-50%);stroke:var(--text-muted);">
                        <circle cx="11" cy="11" r="8"></circle>
                        <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
                    </svg>
                    <input type="text" class="search-input" placeholder="Cari nama / NIP…" id="searchInput"
                        oninput="filterTable()">
                </div>
                <!-- Filters -->
                ...
                <table id="attendanceTable">
                    <thead>
                        <tr>
                            ...
                            <th onclick="sortTable(7)">Lokasi</th>
                            <th onclick="sortTable(8)">Telat</th>
                            <th onclick="sortTable(9)">Lembur</th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div class="pagination">
                <div class="pagination-info">Menampilkan <span id="startRecord">1</span>-<span id="endRecord">10</span>
                    dari <span id="totalRecords">0</span> data</div>
                <div class="pager">
